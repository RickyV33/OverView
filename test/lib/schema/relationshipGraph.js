...
describe('Relationship Graph JSON', () => {
  ...
  let failingTestCases = [
      ...
      {title: 'should return false when documentKey field is missing from an item',
      ...
      {title: 'should return false when name field is missing from an item',
          body: {items: [{id: 1, documentKey: 'docKey', type: 35, image: 'url'}, {id: 2, name: 'req', type: 35}],
              relationships: [{id: 1, source: 1, target: 2, type: 36}]}},
      {title: 'should return false when type field is missing from an item',
          body: {items: [{id: 1, documentKey: 'docKey', name: 'story', image: 'url'}, {id: 2, name: 'req', type: 35}],
              relationships: [{id: 1, source: 1, target: 2, type: 36}]}},
      {title: 'should return false when image field is missing from an item',
        body: {items: [{id: 1, documentKey: 'docKey', name: 'story', type: 35}, {id: 2, name: 'req', type: 35}],
          relationships: [{id: 1, source: 1, target: 2, type: 36}]}},
      ...
      {title: 'should return false when id field is missing from a relationship',
          body: {items: [{id: 1, documentKey: 'docKey', name: 'story', type: 35, image: 'url'}, {id: 2, name: 'req', type: 35}],
      ...
      {title: 'should return false when source is missing from a relationship',
          body: {items: [{id: 1, documentKey: 'docKey', name: 'story', type: 35, image: 'url'}, {id: 2, name: 'story', type: 35}],
      ...
      {title: 'should return false when items property is missing from JSON blob',
          body: {relationships: [{id: 1, documentKey: 'docKey', source: 1, target: 2, type: 36, suspect: false}]}},
      {title: 'should return false when relationships property is missing from JSON blob',
          body: {items: [{id: 1, documentKey: 'docKey', name: 'story', type: 35, image: 'url'}, {id: 2, name: 'story', type: 35, suspect: false}]}},
      // test case for duplicate items
      {title: 'should return false when JSON contains duplicate items',
          body: {items: [{id: 1, documentKey: 'docKey', name: 'story', type: 35, image: 'url'}, {id: 1, name: 'story', type: 35}],
  ...
  let passingTestCases = [
      {title: 'should return true when JSON contains at least 1 item and at least 1 relationship',
          body: {name: 'test', items: [{id: 34, documentKey: 'docKey', name: 'story', type: 35, image: 'url', description: 'desc'}],
              relationships: [{id: 1, source: 34, target: 35, type: 35, suspect: false, name: 'test name'}]}},
      {title: 'should return true when JSON contains many items and many relationships with valid properties',
          body: {name: 'test', items: [
            {id: 34, documentKey: 'docKey', name: 'story', type: 35, image: 'url', description: 'description'},
            {id: 1, documentKey: 'docKey', name: 'story', type: 35, image: 'url', description: 'description'},
            {id: 2, documentKey: 'docKey', name: 'req', type: 36, image: 'url', description: 'description'},
            {id: 3, documentKey: 'docKey', name: 'story', type: 35, image: 'url', description: 'description'},
            {id: 4, documentKey: 'docKey', name: 'story', type: 35, image: 'url', description: 'description'},
            {id: 5, documentKey: 'docKey', name: 'req', type: 36, image: 'url', description: 'description'},
            {id: 6, documentKey: 'docKey', name: 'epic', type: 34, image: 'url', description: 'description'}],
       relationships: [{id: 1, source: 6, target: 2, type: 37, suspect: false, name: 'testname'}, {id: 2, source: 6, target: 5, type: 37, suspect: false, name: 'testname'},
           {id: 3, source: 2, target: 1, type: 38, suspect: false, name: 'testname'}, {id: 4, source: 5, target: 4, type: 38, suspect: false, name: 'testname'},
           {id: 5, source: 5, target: 3, type: 38, suspect: false, name: 'testname'}, {id: 6, source: 4, target: 3, type: 39, suspect: false, name: 'testname'}]}}
  ];
