...
describe('Relationship Graph JSON', () => {
  ...
  let passingTestCases = [
      {title: 'should return true when JSON contains at least 1 item and at least 1 relationship',
          body: {name: 'test', items: [{id: 34, documentKey: 'docKey', name: 'story', type: 35, image: 'url', description: 'description'}],
      ...
      {title: 'should return true when JSON contains many items and many relationships with valid properties',
          body: {name: 'test', items: [
            ...
            {id: 2, documentKey: 'docKey', name: 'req', type: 36, image: 'url', description: 'description'}, {id: 3, name: 'story', type: 35, image: 'url', description: 'description'},
            {id: 4, documentKey: 'docKey', name: 'story', type: 35, image: 'url', description: 'description'}, {id: 5, name: 'req', type: 36, image: 'url', description: 'description'},
