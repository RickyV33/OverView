...
/**
 * Retrieve all the item types. Item types contain image urls which are then copied to each node so that they may be
 * displayed in the graph.
 *
 * @param url
 * @returns {Request}
 */
function getProjectItemTypes (url) {
...
module.exports = {
  ...
  getProjectItemTypes: getProjectItemTypes,
