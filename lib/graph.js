...
class Graph {
  ...
  buildGraph () {
    ...
    //     //  ----------------------
    //     projectquire.getProjectName(this.projectId, this.url).then(name => {
    //       this.name = name;
    //     }, error => {
    //       if (error.code === 'ETIMEDOUT' || error.connect === true) {
    //         // On a timeout, attempt to get the data again
    ...
    //     // | Getting items |
    //     //  ---------------
    //     projectquire.getProjectItems(this.projectId, this.url).then(items => {
    //       this.nodes = items;
    //     }, error => {
    //       if (error.code === 'ETIMEDOUT' || error.connect === true) {
    //         // On a timeout, attempt to get the data again
    ...
    //     //  -----------------------
    //     projectquire.getProjectRelationships(this.projectId, this.url).then(
    //       relationships => {
