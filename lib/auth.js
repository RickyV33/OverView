 ...
 *
 * This function will either return a resolved promise with a payload of projects or a rejected promise.
 *
 * @param {String} username
 * @param {String} password
 * @param {String} teamName
 * @return {Promise} the promise will either be resolved with a payload of projects or will be rejected
 */
 ...
 * teamName: non empty string containing the user's team name from the environment variable
 * Returns true if login credentials are in required format, false otherwise
 *
 * @param {Object} req
 * @return {boolean} true if login credentials are in required format, false otherwise
 */
