 ...
 * @param startAt Numeric value used to mark the starting point of each page (interval is set to 20)
 * @param maxResults Maximum number of items to collect in the array of response data
 * @returns {Promise} If resolved, the payload that contains all data from the pages is returned. Else, an
