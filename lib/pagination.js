 ...
 * given page from a given endpoint endpoint into an array of response data. Collection continues until
 * either the end of the paged data is reached or the number of items collected is equal to a given
 * number of maximum results, whichever comes first.
 *
 * @param baseUrl
 * @param startAt
 * @param maxResults
