...
`.env.example` and modifying it as is necessary for the environment. In a new line beneath the `SESSION_SECRET`, add the team name, assigned to a new `TEAM_NAME` variable. *The `SESSION_SECRET` variable must be changed to
any unique String.*
